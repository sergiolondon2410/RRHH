							...
							@if(count($competences) > 0)
								<div class="row">
									@foreach($competences as $competence)
										<div class="col-lg-8">
											<p><strong>{{ $competence->name }}: </strong>
											<div class="progress">
												<div id="{{ $competence->id }}" class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="{{ ($user_competences['competences_avg'][$competence->id]['total'])*100 }}" aria-valuemin="0" aria-valuemax="100" style="width: {{ ($user_competences['competences_avg'][$competence->id]['total'])*100 }}%;">
													{{ ($user_competences["competences_avg"][$competence->id]["total"])*100 }}%
												</div>
											</div></p>
										</div>
									@endforeach
