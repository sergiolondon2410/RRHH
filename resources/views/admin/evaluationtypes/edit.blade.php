...
@section('content')
	...
	{!! Form::model($evaluationtype, ['method' => 'POST', 'action' => ['EvaluationTypeController@update', $evaluationtype],  'files' => true])  !!}
	 	@method('PUT')
		<div class="row">
            <div class="col-lg-10">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                {!! Form::submit('Editar tipo de evaluación', ['class' => 'form-control btn btn-default']) !!}
                            </div>
                        </div>
                        <!-- /.row (nested) -->
                    </div>
